...
function openRightPanel(n, s, i = !1, r = !1) {
    chrome.system.display.getInfo(e => {
        var {
            width: t,
            height: o
        } = e[0].workArea, a = Math.round(.33 * t), e = Math.round(t - a);
...
chrome.storage.local.get(["isLogged"], ({
    ...
    case "add_quiz_self":
        var a = e.data.ans;
        a && "object" == typeof a && (e.data.ans = Object.values(a)), quizSelf[e.seq] = e.data, console.debug(e.data.ans), console.debug(quizSelf);
        break;
    case "finish_quiz":
    ...
    case "fetch_post":
        ...
        fetch(t.url, {
            ...
            body: e,
            headers: t.headers
        }).then(e => e.json()).then(e => o(e)).catch(e => o(e));
        break;
    case "open_quiz_link":
        openQuizLink(o);
        break;
    ...
    "premium_expired" == e && 0 == t && chrome.tabs.create({
